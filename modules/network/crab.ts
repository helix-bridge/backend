...
export const crabNetworkData = config.CRAB;

export const crabNetworkConfig: NetworkConfig = {
    data: crabNetworkData,
    contentService: new GithubContentService(),
    provider: new ethers.providers.JsonRpcProvider({ url: crabNetworkData.rpcUrl, timeout: 60000 }),
    poolAprServices: [
        // new YbTokensAprService(crabNetworkData.ybAprConfig, crabNetworkData.chain.prismaId),
        new BoostedPoolAprService(),
        new SwapFeeFromEventsAprService(),
        // new GaugeAprService(tokenService, [crabNetworkData.bal!.address]),
    ],
    // userStakedBalanceServices: [new UserSyncGaugeBalanceService()],
    userStakedBalanceServices: [],
    services: {
        balancerSubgraphService: new BalancerSubgraphService(
            crabNetworkData.subgraphs.balancer,
            crabNetworkData.chain.prismaId,
        ),
    },
    /*
