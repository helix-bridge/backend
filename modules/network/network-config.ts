...
import { crabNetworkConfig } from './crab';
...
export const AllNetworkConfigsKeyedOnChain: { [chain in Chain]: NetworkConfig } = {
    ...
    CRAB: crabNetworkConfig,
};

export const BalancerChainIds = ['1', '44', '137', '42161', '100', '1101', '43114', '8453', '11155111', '252', '34443'];
